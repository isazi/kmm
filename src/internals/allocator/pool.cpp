...
struct PoolAllocator::Region {
    ...
    Region(Block* parent, size_t offset_in_block, size_t size, GPUEventSet deps={}) {
        this->parent = parent;
...
struct PoolAllocator::Block {
    ...
    Block(void* addr, size_t size, GPUEventSet deps) {
...
bool PoolAllocator::allocate(size_t nbytes, void*& addr_out, GPUEventSet& deps_out) {
...
void PoolAllocator::deallocate(void* addr, size_t nbytes, GPUEventSet deps) {
